...
```bash
git clone https://github.com/StepFi-app/StepFi-Frontend.git
cd StepFi-Frontend
```
...
This frontend connects to the [StepFi API](https://github.com/StepFi-app/StepFi-API) backend.
...
2. Follow the [StepFi API Contributing Guide](https://github.com/StepFi-app/StepFi-API/blob/main/docs/contributing.md)
...
- 🔗 [Backend API Docs](https://github.com/StepFi-app/StepFi-API)
